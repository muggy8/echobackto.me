	...
	<body>
		...
		<main>
			...
			<div id="about-tab" class="tab-body loading-cloak">
				...
				<p><strong>Offline Usage:</strong> I have recently turned this app into a Progressive Web App and thus it will now support offline mode. You can feel free to return to this page on your device at any time.</p>
